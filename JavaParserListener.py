# Generated from grammars-v4-master/java/java/JavaParser.g4 by ANTLR 4.7.2
from antlr4 import *
...
class JavaParserListener(ParseTreeListener):
    ...
    def enterVariableDeclarator(self, ctx:JavaParser.VariableDeclaratorContext):
        if ctx.variableDeclaratorId():
            self.variables.append(ctx.variableDeclaratorId().getText())
    ...
    def enterFormalParameter(self, ctx:JavaParser.FormalParameterContext):
        if ctx:
            self.parameters.append(ctx.variableDeclaratorId().getText())
    ...
    def enterMethodCall(self, ctx:JavaParser.MethodCallContext):
        if ctx.IDENTIFIER():
            self.methodCalls.append(ctx.IDENTIFIER().getText())
