...
class JavaScriptParser ( JavaScriptParserBase ):
    ...
    def catchProduction(self):
        ...
        try:
            ...
            if _la==JavaScriptParser.OpenParen:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if _la==JavaScriptParser.OpenBracket or _la==JavaScriptParser.OpenBrace or ((((_la - 105)) & ~0x3f) == 0 and ((1 << (_la - 105)) & ((1 << (JavaScriptParser.Async - 105)) | (1 << (JavaScriptParser.NonStrictLet - 105)) | (1 << (JavaScriptParser.Identifier - 105)))) != 0):
                    self.state = 460
                    self.assignable()
    ...
    def functionDeclaration(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << JavaScriptParser.OpenBracket) | (1 << JavaScriptParser.OpenBrace) | (1 << JavaScriptParser.Ellipsis))) != 0) or ((((_la - 105)) & ~0x3f) == 0 and ((1 << (_la - 105)) & ((1 << (JavaScriptParser.Async - 105)) | (1 << (JavaScriptParser.NonStrictLet - 105)) | (1 << (JavaScriptParser.Identifier - 105)))) != 0):
                self.state = 483
    ...
    def singleExpression(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if ((((_la - 105)) & ~0x3f) == 0 and ((1 << (_la - 105)) & ((1 << (JavaScriptParser.Async - 105)) | (1 << (JavaScriptParser.NonStrictLet - 105)) | (1 << (JavaScriptParser.Identifier - 105)))) != 0):
                    self.state = 738
                    self.identifier()
    ...
    def identifier(self):
        ...
        try:
            ...
            self.state = 961
            _la = self._input.LA(1)
            if not(((((_la - 105)) & ~0x3f) == 0 and ((1 << (_la - 105)) & ((1 << (JavaScriptParser.Async - 105)) | (1 << (JavaScriptParser.NonStrictLet - 105)) | (1 << (JavaScriptParser.Identifier - 105)))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
