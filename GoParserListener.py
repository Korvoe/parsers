...
class GoParserListener(ParseTreeListener):
    ...
    def enterVarDecl(self, ctx:GoParser.VarDeclContext):
        if ctx.varSpec():
            self.variables.append(ctx.varSpec()[0].getText())
    ...
    def enterShortVarDecl(self, ctx:GoParser.ShortVarDeclContext):
        if ctx.identifierList():
            self.variables.append(ctx.identifierList().getText())
    ...
    def enterTypeName(self, ctx:GoParser.TypeNameContext):
        self.dataTypes.append(ctx.getText())
    ...
    def enterParameterDecl(self, ctx:GoParser.ParameterDeclContext):
        if ctx.identifierList():
            self.parameters.append(ctx.identifierList().getText())
    ...
    def enterPrimaryExpr(self, ctx:GoParser.PrimaryExprContext):
        if ctx.IDENTIFIER():
            self.funcCalls.append(ctx.IDENTIFIER().getText())
            print("identifier: " + ctx.IDENTIFIER().getText())
        print("expression: " + ctx.getText())
        self.expressions.append(ctx.getText())
    ...
    # Enter a parse tree produced by GoParser#anonymousField.
    def enterAnonymousField(self, ctx:GoParser.AnonymousFieldContext):
        pass

    # Exit a parse tree produced by GoParser#anonymousField.
    def exitAnonymousField(self, ctx:GoParser.AnonymousFieldContext):
        pass
    ...
    # Enter a parse tree produced by GoParser#slice.
    def enterSlice(self, ctx:GoParser.SliceContext):
        pass

    # Exit a parse tree produced by GoParser#slice.
    def exitSlice(self, ctx:GoParser.SliceContext):
        pass
