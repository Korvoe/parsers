...
class JavaScriptParserListener(ParseTreeListener):
    ...
    def enterVariableDeclaration(self, ctx:JavaScriptParser.VariableDeclarationContext):
        if ctx.assignable():
            self.variables.append(ctx.assignable().getText())
    ...
    def enterFormalParameterArg(self, ctx:JavaScriptParser.FormalParameterArgContext):
        self.parameters.append(ctx.getText())
    ...
    def enterIdentifierName(self, ctx:JavaScriptParser.IdentifierNameContext):
        if ctx.identifier():
            self.identifiers.append(ctx.identifier().getText())
    ...
    # Enter a parse tree produced by JavaScriptParser#let.
    def enterLet(self, ctx:JavaScriptParser.LetContext):
        pass

    # Exit a parse tree produced by JavaScriptParser#let.
    def exitLet(self, ctx:JavaScriptParser.LetContext):
        pass
